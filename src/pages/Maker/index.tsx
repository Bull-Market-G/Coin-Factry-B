import MakerArrowImg from 'assets/images/maker_arrow.png'
import MakerCoinImg from 'assets/images/MakerCoin.png'
...
export default function Maker() {
  ...
  const tokenAddress = '0xcD012806571A7C04227BE82D4bf0046fd5832F84' // Maker Coin
            ...
            <AutoColumn gap="10px" justify="center" style={{ width: '100%' }}>
              ...
              >
                <AutoRow justify="center">
                  <AutoColumn>
                    <img src={MakerCoinImg} width="200px" />
                    <AutoColumn>
                  ...
                  <img src={MakerArrowImg} width="460px" height="220px" />
                </AutoRow>
                <AutoColumn>
                  <AutoRow marginBottom="10px">
                    ...
                    {sendAddress ? (
                      coinBalance ? (
                        <TYPE.main marginLeft="auto">{`Balance: ${coinBalance} Maker Coin`}</TYPE.main>
                      ) : (
                        <TYPE.main marginLeft="auto">{`Balance: 0 Maker Coin`}</TYPE.main>
                      )
                    ) : null}
                  </AutoRow>
                  <StyledInputAddress
