import ApeArrowImg from 'assets/images/ape_arrow.png'
import ApeCoinImg from 'assets/images/ApeCoin.png'
...
export default function Ape() {
  ...
  const tokenAddress = '0x785d943D5BE9f14EEa6a4e8F62E77D4e7E0df545' // Ape Coin
            ...
            <AutoColumn gap="10px" justify="center" style={{ width: '100%' }}>
              ...
              >
                <AutoRow justify="center">
                  <AutoColumn>
                    <img src={ApeCoinImg} width="200px" />
                    <AutoColumn>
                  ...
                  <img src={ApeArrowImg} width="460px" height="220px" />
                </AutoRow>
                <AutoColumn>
                  <AutoRow marginBottom="10px">
                    ...
                    {sendAddress ? (
                      coinBalance ? (
                        <TYPE.main marginLeft="auto">{`Balance: ${coinBalance} Ape Coin`}</TYPE.main>
                      ) : (
                        <TYPE.main marginLeft="auto">{`Balance: 0 Ape Coin`}</TYPE.main>
                      )
                    ) : null}
                  </AutoRow>
                  <StyledInputAddress
