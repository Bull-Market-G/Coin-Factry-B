import PolygonArrowImg from 'assets/images/polygon_arrow.png'
import PolygonCoinImg from 'assets/images/PolygonCoin.png'
...
export default function Polygon() {
  ...
  const tokenAddress = '0x3Bc7b0745e5ef88fd074a4aaE47Cb8cFB1731458' // Polygon Coin
            ...
            <AutoColumn gap="10px" justify="center" style={{ width: '100%' }}>
              ...
              >
                <AutoRow justify="center">
                  <AutoColumn>
                    <img src={PolygonCoinImg} width="200px" />
                    <AutoColumn>
                  ...
                  <img src={PolygonArrowImg} width="460px" height="220px" />
                </AutoRow>
                <AutoColumn>
                  <AutoRow marginBottom="10px">
                    ...
                    {sendAddress ? (
                      coinBalance ? (
                        <TYPE.main marginLeft="auto">{`Balance: ${coinBalance} Polygon Coin`}</TYPE.main>
                      ) : (
                        <TYPE.main marginLeft="auto">{`Balance: 0 Polygon Coin`}</TYPE.main>
                      )
                    ) : null}
                  </AutoRow>
                  <StyledInputAddress
