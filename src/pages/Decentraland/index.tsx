import DecentralandArrowImg from 'assets/images/decentraland_arrow.png'
import DecentralandCoinImg from 'assets/images/DecentralandCoin.png'
...
export default function Decentraland() {
  ...
  const tokenAddress = '0xAc5875B6446821E5Facf905aDa9b78F6F4289b46' // Decentraland Coin
            ...
            <AutoColumn gap="10px" justify="center" style={{ width: '100%' }}>
              ...
              >
                <AutoRow justify="center">
                  <AutoColumn>
                    <img src={DecentralandCoinImg} width="200px" />
                    <AutoColumn>
                  ...
                  <img src={DecentralandArrowImg} width="460px" height="220px" />
                </AutoRow>
                <AutoColumn>
                  <AutoRow marginBottom="10px">
                    ...
                    {sendAddress ? (
                      coinBalance ? (
                        <TYPE.main marginLeft="auto">{`Balance: ${coinBalance} Decentraland Coin`}</TYPE.main>
                      ) : (
                        <TYPE.main marginLeft="auto">{`Balance: 0 Decentraland Coin`}</TYPE.main>
                      )
                    ) : null}
                  </AutoRow>
                  <StyledInputAddress
