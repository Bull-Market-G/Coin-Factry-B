import TetherArrowImg from 'assets/images/tether_arrow.png'
import TetherCoinImg from 'assets/images/TetherCoin.png'
...
export default function Tether() {
  ...
  const tokenAddress = '0x641F7C43eB943854bbF1c5EeBC5e7b358eaB77A1' // Tether Coin
            ...
            <AutoColumn gap="10px" justify="center" style={{ width: '100%' }}>
              ...
              >
                <AutoRow justify="center">
                  <AutoColumn>
                    <img src={TetherCoinImg} width="200px" />
                    <AutoColumn>
                  ...
                  <img src={TetherArrowImg} width="460px" height="220px" />
                </AutoRow>
                <AutoColumn>
                  <AutoRow marginBottom="10px">
                    ...
                    {sendAddress ? (
                      coinBalance ? (
                        <TYPE.main marginLeft="auto">{`Balance: ${coinBalance} Tether Coin`}</TYPE.main>
                      ) : (
                        <TYPE.main marginLeft="auto">{`Balance: 0 Tether Coin`}</TYPE.main>
                      )
                    ) : null}
                  </AutoRow>
                  <StyledInputAddress
