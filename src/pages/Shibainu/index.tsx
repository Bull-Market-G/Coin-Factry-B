import ShibainuArrowImg from 'assets/images/shibainu_arrow.png'
import ShibainuCoinImg from 'assets/images/ShibainuCoin.png'
...
export default function Shibainu() {
  ...
  const tokenAddress = '0x959832d8f790f95cB706C4867a1bBb96C5C84d07' // Shibainu Coin
            ...
            <AutoColumn gap="10px" justify="center" style={{ width: '100%' }}>
              ...
              >
                <AutoRow justify="center">
                  <AutoColumn>
                    <img src={ShibainuCoinImg} width="200px" />
                    <AutoColumn>
                  ...
                  <img src={ShibainuArrowImg} width="460px" height="220px" />
                </AutoRow>
                <AutoColumn>
                  <AutoRow marginBottom="10px">
                    ...
                    {sendAddress ? (
                      coinBalance ? (
                        <TYPE.main marginLeft="auto">{`Balance: ${coinBalance} Shibainu Coin`}</TYPE.main>
                      ) : (
                        <TYPE.main marginLeft="auto">{`Balance: 0 Shibainu Coin`}</TYPE.main>
                      )
                    ) : null}
                  </AutoRow>
                  <StyledInputAddress
