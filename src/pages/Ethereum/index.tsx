import EthereumArrowImg from 'assets/images/ethereum_arrow.png'
import EthereumCoinImg from 'assets/images/EthereumCoin.png'
...
export default function Ethereum() {
  ...
  const tokenAddress = '0x0473e6d6F70838A21Ef256c20910015251DdA37c' // Ethereum Coin
            ...
            <AutoColumn gap="10px" justify="center" style={{ width: '100%' }}>
              ...
              >
                <AutoRow justify="center">
                  <AutoColumn>
                    <img src={EthereumCoinImg} width="200px" />
                    <AutoColumn>
                  ...
                  <img src={EthereumArrowImg} width="460px" height="220px" />
                </AutoRow>
                <AutoColumn>
                  <AutoRow marginBottom="10px">
                    ...
                    {sendAddress ? (
                      coinBalance ? (
                        <TYPE.main marginLeft="auto">{`Balance: ${coinBalance} Ethereum Coin`}</TYPE.main>
                      ) : (
                        <TYPE.main marginLeft="auto">{`Balance: 0 Ethereum Coin`}</TYPE.main>
                      )
                    ) : null}
                  </AutoRow>
                  <StyledInputAddress
