import AaveCoinArrowImg from 'assets/images/aave_arrow.png'
import AaveCoinImg from 'assets/images/AaveCoin.png'
...
export default function Aave() {
  ...
  const tokenAddress = '0xA54409E121A06b0dBDAd4b7873678765F3Ba0f14' // Aave Coin
            ...
            <AutoColumn gap="10px" justify="center" style={{ width: '100%' }}>
              ...
              >
                <AutoRow justify="center">
                  <AutoColumn>
                    <img src={AaveCoinImg} width="200px" />
                    <AutoColumn>
                  ...
                  <img src={AaveCoinArrowImg} width="460px" height="220px" />
                </AutoRow>
                <AutoColumn>
