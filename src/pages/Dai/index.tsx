import DaiArrowImg from 'assets/images/dai_arrow.png'
import DaiCoinImg from 'assets/images/DaiCoin.png'
...
export default function Dai() {
  ...
  const tokenAddress = '0xf305908d2E0227d84aaba6A03eeCFC722BAC6d23' // Dai Coin
            ...
            <AutoColumn gap="10px" justify="center" style={{ width: '100%' }}>
              ...
              >
                <AutoRow justify="center">
                  <AutoColumn>
                    <img src={DaiCoinImg} width="200px" />
                    <AutoColumn>
                  ...
                  <img src={DaiArrowImg} width="460px" height="220px" />
                </AutoRow>
                <AutoColumn>
                  <AutoRow marginBottom="10px">
                    ...
                    {sendAddress ? (
                      coinBalance ? (
                        <TYPE.main marginLeft="auto">{`Balance: ${coinBalance} Dai Coin`}</TYPE.main>
                      ) : (
                        <TYPE.main marginLeft="auto">{`Balance: 0 Dai Coin`}</TYPE.main>
                      )
                    ) : null}
                  </AutoRow>
                  <StyledInputAddress
