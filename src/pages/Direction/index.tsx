import DirectionArrowImg from 'assets/images/direction_arrow.png'
import DirectionCoinImg from 'assets/images/DirectionCoin.png'
...
export default function Direction() {
  ...
  const tokenAddress = '0x2Afc7842c43010024C05a4AB6C77a7112FD46D21' // Direction Coin
            ...
            <AutoColumn gap="10px" justify="center" style={{ width: '100%' }}>
              ...
              >
                <AutoRow justify="center">
                  <AutoColumn>
                    <img src={DirectionCoinImg} width="200px" />
                    <AutoColumn>
                  ...
                  <img src={DirectionArrowImg} width="460px" height="220px" />
                </AutoRow>
                <AutoColumn>
                  <AutoRow marginBottom="10px">
                    ...
                    {sendAddress ? (
                      coinBalance ? (
                        <TYPE.main marginLeft="auto">{`Balance: ${coinBalance} Direction Coin`}</TYPE.main>
                      ) : (
                        <TYPE.main marginLeft="auto">{`Balance: 0 Direction Coin`}</TYPE.main>
                      )
                    ) : null}
                  </AutoRow>
                  <StyledInputAddress
